                            ...
                            <div class="row">
                                    ...
                                    @foreach ($TECHNICAL_SUBJECTS as $subject)
                                        <div class="form-check">
                                            ...
                                            <input class="form-check-input" type="checkbox"
                                                id="technical-subject-{{ $loop->index }}"
                                                value="{{$subject->md_id}}">
                                ...
                                <div class="col-lg-3 col-md-12">
                                    ...
                                    @foreach ($OPTIONALS as $subject)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                id="optional-subject-{{ $loop->index }}"
                                                value="{{$subject->md_id}}">
                                            <label class="form-check-label"
                                ...
                                <div class="col-lg-3 col-md-12">
                                    ...
                                    @foreach ($VOCATIONALS as $subject)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                id="vocational-subject-{{ $loop->index }}"
                                                value="{{$subject->md_id}}">
                                            <label class="form-check-label"
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-12">
                                    ...
                                    @foreach ($LANGUAGES as $subject)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                id="language-subject-{{ $loop->index }}"
                                                value="{{$subject->md_id}}">
                                            <label class="form-check-label"
                                ...
                                <div class="col-lg-3 col-md-12">
                                    ...
                                    @foreach ($HUMANITIES as $subject)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                id="humanity-subject-{{ $loop->index }}"
                                                value="{{$subject->md_id}}">
                                            <label class="form-check-label"
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                // Optionally, uncheck all checkboxes after successful submission
